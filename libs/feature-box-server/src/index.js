...
export const composeApiBox = Task(
  t => (props, parts) => {
    ...
    const lifecycle = t.mapObjIndexed(
      (val) => {
        return (a) => {
          t.forEach(action => {
